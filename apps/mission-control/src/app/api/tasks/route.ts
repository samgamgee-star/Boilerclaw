...
export async function POST(request: NextRequest) {
  try {
    ...
    // Auto-populate workflow roles using the workspace default policy.
    // If an owner agent is selected, use owner-based defaults first (for example: Coder/Coder/Sam).
