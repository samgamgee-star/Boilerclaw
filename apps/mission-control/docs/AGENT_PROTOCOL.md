...
### Default role policy
For new execution-grade tasks, Mission Control should auto-fill workflow roles from the primary owner agent:
...
This keeps the workflow systematic across task types without forcing new permanent agents for every role.
